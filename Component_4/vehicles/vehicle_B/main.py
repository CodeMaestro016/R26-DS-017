# vehicles/vehicle_B/main.py
# Vehicle B Local Pipeline
...
def main():
    ...
    print("=" * 60)
    print("Vehicle B Local Pipeline")
    print("=" * 60)
    ...
    for sign_number, sign_data in enumerate(
        ...
        if vehicle_id != "Vehicle_B":
            print(
                "Status              : "
                "REWARD_NOT_FOR_VEHICLE_B"
            )
