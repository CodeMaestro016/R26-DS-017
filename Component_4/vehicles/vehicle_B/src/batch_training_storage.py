# vehicles/vehicle_B/src/batch_training_storage.py
# Save verified cropped traffic-sign images for later
# Vehicle B CNN batch training.
...
class BatchTrainingStorage:
    ...
    class ID received from Vehicle B's temporary database.

    Folder structure:

        vehicles/vehicle_B/data/batch_training/
            class_0/
            class_1/
            class_2/
            ...
