# ==========================================================
# vehicles/vehicle_B/src/local_model_retraining.py
#
# Vehicle B - Local CNN Retraining
#
# IMPORTANT:
...
# - vehicle_B_class_mapping.json defines the mapping.
# ==========================================================
...
# ==========================================================
# EXPECTED VEHICLE B MODEL ARCHITECTURE
# ==========================================================
...
# ==========================================================
# VEHICLE B LOCAL MODEL RETRAINER
# ==========================================================

class VehicleBLocalModelRetrainer:
    ...
    def load_current_model(self):
        ...
        print("\n" + "=" * 60)
        print("Loading Existing Vehicle B CNN")
        print("=" * 60)
        ...
        if output_count != EXPECTED_OUTPUT_CLASSES:
            ...
            raise ValueError(
                "\nVehicle B model must already have "
                "43 output classes.\n"
        ...
        if (
            ...
            raise ValueError(
                "\nUnexpected Vehicle B input shape.\n"
    ...
    def find_final_classification_layer(self):
        ...
        if not isinstance(
            ...
            raise ValueError(
                "Final Vehicle B layer must be Dense.\n"
    ...
    def load_existing_class_mapping(self):
        ...
        print("\n" + "=" * 60)
        print("Loading Vehicle B Class Mapping")
        print("=" * 60)
    ...
    def retrain(self):
        ...
        print("\n")
        print("=" * 60)
        print("Vehicle B Local CNN Retraining")
        print("=" * 60)
