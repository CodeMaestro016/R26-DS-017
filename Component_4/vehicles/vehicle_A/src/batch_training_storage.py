# vehicles/vehicle_A/src/batch_training_storage.py
# Save verified cropped traffic-sign images for later
# Vehicle A CNN batch training.
...
class BatchTrainingStorage:
    ...
    class ID received from Vehicle A's temporary database.

    Folder structure:

        vehicles/vehicle_A/data/batch_training/
            class_0/
            class_1/
            class_2/
            ...
