# ==========================================================
# vehicles/vehicle_A/testing/test.py
#
# VEHICLE A - TESTING PIPELINE
#
# Pipeline:
#   1. Load test images from:
#        vehicles/vehicle_A/data/test/class_X/
#
#   2. YOLO detects the traffic sign in the full image.
#
#   3. Best detected sign is cropped.
#
#   4. Vehicle A CNN classifies the cropped sign.
#
...
# vehicles/vehicle_A
VEHICLE_A_DIR = os.path.dirname(CURRENT_DIR)

# Project root
PROJECT_ROOT = os.path.dirname(VEHICLE_A_DIR)

# Add project paths to Python path
if PROJECT_ROOT not in sys.path:
    sys.path.append(PROJECT_ROOT)

if VEHICLE_A_DIR not in sys.path:
    sys.path.insert(0, VEHICLE_A_DIR)
...
print("\n" + "=" * 70)
print(f"VEHICLE A - TEST RUN {TEST_ID}")
print("=" * 70)
...
print("\nLoading Vehicle A CNN classifier...")
