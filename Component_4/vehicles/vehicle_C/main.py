# vehicles/vehicle_C/main.py
# Vehicle C Local Pipeline
...
def main():
    ...
    print("=" * 60)
    print("Vehicle C Local Pipeline")
    print("=" * 60)
    ...
    for sign_number, sign_data in enumerate(
        ...
        if vehicle_id != "Vehicle_C":
            print(
                "Status              : "
                "REWARD_NOT_FOR_VEHICLE_C"
            )
