# ==========================================================
# vehicles/vehicle_C/src/local_model_retraining.py
#
# Vehicle C - Local CNN Retraining
#
# IMPORTANT:
...
# - vehicle_C_class_mapping.json defines the mapping.
# ==========================================================
...
ACTIVE_MODEL_PATH = os.path.join(
    MODEL_DIR,
    "vehicle_C_cnn_danger.keras"
)

CLASS_MAPPING_PATH = os.path.join(
    MODEL_DIR,
    "vehicle_C_class_mapping.json"
)
...
# ==========================================================
# EXPECTED VEHICLE C MODEL ARCHITECTURE
# ==========================================================
...
# ==========================================================
# VEHICLE C LOCAL MODEL RETRAINER
# ==========================================================

class VehicleCLocalModelRetrainer:
    ...
    def load_current_model(self):
        ...
        print("\n" + "=" * 60)
        print("Loading Existing Vehicle C CNN")
        print("=" * 60)
        ...
        if output_count != EXPECTED_OUTPUT_CLASSES:
            ...
            raise ValueError(
                "\nVehicle C model must already have "
                "43 output classes.\n"
        ...
        if (
            ...
            raise ValueError(
                "\nUnexpected Vehicle C input shape.\n"
    ...
    def find_final_classification_layer(self):
        ...
        if not isinstance(
            ...
            raise ValueError(
                "Final Vehicle C layer must be Dense.\n"
    ...
    def load_existing_class_mapping(self):
        ...
        print("\n" + "=" * 60)
        print("Loading Vehicle C Class Mapping")
        print("=" * 60)
    ...
    def retrain(self):
        ...
        print("\n")
        print("=" * 60)
        print("Vehicle C Local CNN Retraining")
        print("=" * 60)
