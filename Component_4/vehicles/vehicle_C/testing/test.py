# ==========================================================
# vehicles/vehicle_C/testing/test.py
#
# VEHICLE C - TESTING PIPELINE
#
# Pipeline:
#   1. Load test images from:
#        vehicles/vehicle_C/data/test/class_X/
#
#   2. YOLO detects the traffic sign in the full image.
#
#   3. Best detected sign is cropped.
#
#   4. Vehicle C CNN classifies the cropped sign.
#
...
# vehicles/vehicle_C
VEHICLE_C_DIR = os.path.dirname(CURRENT_DIR)

# Project root
PROJECT_ROOT = os.path.dirname(VEHICLE_C_DIR)

# Add project paths to Python path
if PROJECT_ROOT not in sys.path:
    sys.path.append(PROJECT_ROOT)

if VEHICLE_C_DIR not in sys.path:
    sys.path.insert(0, VEHICLE_C_DIR)
...
from src.cnn_classifier import VehicleCCNN
...
print("\n" + "=" * 70)
print(f"VEHICLE C - TEST RUN {TEST_ID}")
print("=" * 70)
...
print("\nLoading Vehicle C CNN classifier...")
